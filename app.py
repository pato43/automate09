...
if uploaded_file:
    ...
    n_samples = X.shape[0]
    n_clusters = min(3, n_samples)  # No más clusters que muestras
    ...
    X_train, X_test, y_train, y_test = train_test_split(
        pd.get_dummies(ventas_sucursal['Sucursal']), ventas_sucursal['Venta_Total'],
    ...
    # --- Mostrar 3 gráficas en la misma fila ---
    ...
    ### 5. Participación de Métodos de Pago ###
    ...
    fig_pago = px.pie(metodo_pago, names='Metodo', values='Cantidad', title='Métodos de Pago')
    ...
    fig_mes = px.line(ventas_mes, x='Mes', y='Venta_Total', title='Ventas por Mes')

    # --- Mostrar otras 3 gráficas en fila ---
